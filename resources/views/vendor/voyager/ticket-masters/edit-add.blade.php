...
@section('content')
                ...
                <div class="panel panel-bordered">
                    ...
                    <form id="myform" action="{{url('/ticket_masters')}}" method="post" >
                        ...
                        <div class="panel-footer">
                            <button id="btn-submit" type="submit" class="btn btn-primary save">{{ __('voyager::generic.save') }}</button>
                        </div>
                    </form>
    ...
    <div class="modal fade modal-info" id="qr">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><i class="voyager-warning"></i> INFO</h4>
                </div>

                <div class="modal-body">
                    <h4> QR Goes Here '<span class="confirm_delete_name"></span>'</h4>
