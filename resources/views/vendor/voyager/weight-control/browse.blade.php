            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        @if ($isServerSide)
                            <span>SEARCH BAR IS CASE SENSITIVE</span>
                            <form method="get" class="form-search">
                                <div id="search-input">
                                    <select id="search_key" name="key">
                                        ...
                                        @endforeach
                                        <option value="ID" @if($search->key == 'ID') {{ 'selected' }} @endif >ID</option>
                                        <option value="MODEL_NAME" @if($search->key == 'MODEL_NAME') {{ 'selected' }} @endif>MODEL_NAME</option>
                                        <option value="STDWEIGHT" @if($search->key == 'STDWEIGHT') {{ 'selected' }} @endif>STDWEIGHT</option>
                                        <option value="TOLERANCE" @if($search->key == 'TOLERANCE') {{ 'selected' }} @endif>TOLERANCE</option>
                                        <option value="SCALE" @if($search->key == 'SCALE') {{ 'selected' }} @endif>SCALE</option>
